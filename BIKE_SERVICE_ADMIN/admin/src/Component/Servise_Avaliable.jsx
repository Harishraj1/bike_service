...
//         try {
//             await axios.put(`http://localhost:9000/services/${id}`, editService);
//             setEditService(null);
//             fetchServices();
//         } catch (error) {
...
//                         <Link to="/" className="block p-3 pl-10 text-xl bg-[#AB65F6] text-white rounded-full">Profile</Link>
//                         <Link to="/avaliable_service" className="block p-3 pl-10 text-xl  bg-[#AB65F6] text-white rounded-full">Service Available</Link>
//                         <Link to="/userlogin" className="block p-3 pl-10 text-xl bg-[#AB65F6] text-white rounded-full">Users Login</Link>
//                         <Link to="/service_req" className="block p-3 pl-10 text-xl bg-[#AB65F6] text-white rounded-full">Service Requests</Link>
//                     </div>
//             </nav>
...
//                                 <button onClick={() => handleDelete(service._id)} className="bg-red-500 text-white px-4 py-2 rounded">Delete</button>
...
function Service_Avaliable() {
    ...
    const handleDelete = async () => {
        try {
            if (serviceToDelete) {
                await axios.delete(`http://localhost:9000/services/${serviceToDelete._id}`);
                fetchServices();
